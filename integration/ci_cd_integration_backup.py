...
class SimpleLogger:
    ...
    def __init__(self, name: str):
        ...
        self.messages = {
            ...
            'no_models_found': '⚠️ No models found for scanning',
            'critical_threat': '🚨 Critical threats detected - failing build',
            'high_threat': '⚠️ High threats - build successful with warnings',
...
def main():
    ...
    print(f"⚖️ Scoring Method: {results.get('scoring_method')}")
